...
export default function Cover({ textColor }) {
  ...
  const [mainText] = useState([
    "cciD Center for Creative Intelligence Design",
    "Shaping the future through insight, innovation and impact",
  ]);
  ...
  return (
    <div className="relative flex flex-col w-full h-full lg:pt-[38dvh] pt-[28vh] px-6 lg:px-10">
